...
import 'package:kitap_uyg/pages/add_pages.dart';
...
class MyHomePage extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('SENA ARSLAN KÜTÜPHANE YÖNETİMİ'),
      ),
      body: Center(
        child: Container(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListTile(
        ...
        subtitle: Text(
          'Yazar: ${book['author']}, Sayfa Sayısı: ${book['pageCount']}, Kategori: ${book['genre']}',
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: const Text('Kitabı silmek istediğinizden emin misiniz?'),
          actions: [
            TextButton(
              onPressed: () {
                Navigator.pop(context);
                  ...
                  showDialog(
                    ...
                    builder: (context) {
                      return AlertDialog(
                        ...
                        content: Text('Kitap güncelleme başarılı!'),
                        actions: [
                          TextButton(
                            onPressed: () {
                              Navigator.pop(context);
